                        ...
                        <form method="post" action="{{route('frontend.login')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <a class="forget_pass" href="{{ route('password.request') }}">{{ __('Frontend/auth.forgot_password') }}</a>
                                     <div class="form__btn">
                                         <a href="{{ route('frontend.social_login', 'facebook') }}" class="btn btn-block" style="background-color:#1877F2; color: #ffffff">{{ __('Frontend/auth.login_with_facebook') }}</a>
                                         <a href="{{ route('frontend.social_login', 'twitter') }}" class="btn btn-block" style="background-color:#1DA1F2; color: #ffffff">{{ __('Frontend/auth.login_with_twitter') }}</a>
                                         <a href="{{ route('frontend.social_login', 'google') }}" class="btn btn-block">{{ __('Frontend/auth.login_with_google') }}</a>
                                     </div>
                                 </div>
                        </form>
                    </div>
