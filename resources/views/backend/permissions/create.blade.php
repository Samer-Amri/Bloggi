                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="module" name="module" class="form-control" value="{{old('module')}}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="sidebar_link" name="sidebar_link" class="form-control">
                                <option value=""> --- </option>
                                <option
                                    value="0" {{old('sidebar_link') == '0' ? 'selected' : ''}}>{{__('Backend/permissions.no')}}</option>
                                <option
                                    value="1" {{old('sidebar_link') == '1' ? 'selected' : ''}}>{{__('Backend/permissions.yes')}}</option>
                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="parent" name="parent" class="form-control">
                                    ...
                                    @foreach($main_permissions as $main_perm)
                                        <option
                                            value="{{$main_perm->id}}" {{old('parent') == $main_perm->id ? 'selected' : ''}}>{{$main_perm->display_name()}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="parent_show" name="parent_show" class="form-control">
                                ...
                                @foreach($main_permissions as $main_perm)
                                    <option
                                        value="{{$main_perm->id}}" {{old('parent_show') == $main_perm->id ? 'selected' : ''}}>{{$main_perm->display_name()}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="parent_original" name="parent_original" class="form-control">
                                ...
                                @foreach($main_permissions as $main_perm)
                                    <option
                                        value="{{$main_perm->id}}" {{old('parent_original') == $main_perm->id ? 'selected' : ''}}>{{$main_perm->display_name()}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="appear" name="appear" class="form-control">
                                <option value=""> --- </option>
                                    <option
                                        value="0" {{old('appear') == '0' ? 'selected' : ''}}>{{__('Backend/permissions.no')}}</option>
                                    <option
                                        value="1" {{old('appear') == '1' ? 'selected' : ''}}>{{__('Backend/permissions.yes')}}</option>
                            </select>
