                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="display_name" name="display_name" class="form-control" value="{{old('display_name', $role->display_name())}}">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="display_name_en" name="display_name_en" class="form-control" value="{{old('display_name_en', $role->display_name_en)}}">
                    ...
                    <div class="col-3">
                        ...
                        <select id="allowed_route"  name="allowed_route" class="form-control">
                            <option
                                value=""> --- </option>
                            <option
                                value="admin" {{old('allowed_route', $role->allowed_route) == 'admin' ? 'selected' : ''}}>admin
                            </option>
                        </select>
                        ...
                        <div class="form-group">
                            ...
                            <select id="permissions" name="permissions[]" class="form-control select-multiple-tags" multiple="multiple">
                                @foreach($permissions as $permission)
                                    <option
                                        value="{{$permission->id}}" {{in_array($permission->id, old('permissions[]', $rolePerms))  ? 'selected' : ''}}>{{$permission->display_name()}}</option>
                                @endforeach
                            </select>
